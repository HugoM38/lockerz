...
class EditAccountPageState extends State<EditAccountPage> {
                ...
                builder: (BuildContext context, BoxConstraints constraints) {
                  ...
                  return Column(
                    ...
                    children: [
                      SizedBox(
                        width: maxWidth,
                        child: buildEditAccountForm(context),
                      ),
                    ],
                  );
                },
  ...
  Widget buildEditAccountForm(BuildContext context) {
    return Container(
  ...
  Widget buildSaveNameButton(BuildContext context) {
    return SizedBox(
